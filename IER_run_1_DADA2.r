...
saveRDS(seqtab, "/Users/whitneyware/IER_Sleeve/IER_Run_1_seqs/IER_run_1_seqtab.rds") # CHANGE ME to where you want sequence table saved


# Merge multiple runs (if necessary)
st1 <- readRDS("/Users/whitneyware/IER_Sleeve/IER_Run_1_seqs/IER_run_1_seqtab.rds")
st2 <- readRDS("/Users/whitneyware/IER_Sleeve/IER_Run_1_seqs/IER_run_2_seqtab.rds")
...
# Write to disk
saveRDS(seqtab, "/Users/whitneyware/IER_Sleeve/IER_Run_1_seqs/IER_combined_seqtab_final.rds") # CHANGE ME to where you want sequence table saved
